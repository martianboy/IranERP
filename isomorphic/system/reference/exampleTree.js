        ...
        children:[
            {
                ...
                children:[
                    ...
                    {
                        icon:"[ISO_DOCS_SKIN]/images/silkicons/pencil.png",
                        ref:"Drawing",
                    ...
                    },
                    {
                        ...
                        children:[
                            ...
                            },
                            {
                                ...
                                title:"Text - Masked",
                                description:"\n            TextItems support a masked entry to restrict and format entry.\n            "
                            },
                            {
                                id:"textAreaItem",
                        ...
                        children:[
                            {
                                ...
                                id:"hibernateWizard",
                                jsURL:"serverExamples/hibernate/vb_Hibernate.js",
                                requiresModules:"SCServer",
                                showSkinSwitcher:false,
                                showSource:false,
                            ...
                            },
                            {
                                ...
                                descriptionHeight:"220",
                                description:"\n            The Hibernate Connector gives you the ability to immediately connect SmartClient \n            components to Hibernate without writing any code.  You can hook straight into \n            existing Hibernate mapped entities, or use the Hibernate connector in \"beanless\"\n            mode - SmartClient Server will create a mapping for you on the fly, based on the \n            DataSource definition; no code or Hibernate config is required.\n            <P>\n            You can use the Hibernate Wizard in Visual Builder to generate a DataSource\n            descriptor (.ds.xml file) from an existing Hibernate mapping.  Or, for a beanless\n            DataSource, you can use the SQL (via Hibernate) Wizard to generate a DataSource \n            descriptor from an existing SQL table, accessed via your Hibernate connection.  \n            Or, use the Admin Console to generate a SQL table, via your Hibernate connection, \n            from a DataSource descriptor you write.  Whichever way you choose, you get the \n            immediate ability to perform all 4 basic data operations (select, insert, update, \n            delete) from any of SmartClient's data-aware components.\n            <P>\n            The grid below is connected to a beanless Hibernate DataSource and has settings \n            enabled to allow this grid to perform all 4 operations.  Type in the input boxes \n            above each column to do query by example.  Note that data paging is automatically \n            enabled - just scroll to load data on demand.  Click on a red X to delete a record.\n            Click on a record to edit it and click \"Add New\" to add a new record.\n            <P>\n            It's easy to add business logic that takes place before and after Hibernate \n            operations to enforce security or add additional data validation rules.\n            <P>\n            In beanless mode, the Hibernate connector is valuable for initial prototypes and for\n            lightweight storage when a full ORM approach would be overkill.  In mapped-bean mode,\n            the Hibernate connector provides full connectivity to your enterprise storage from \n            SmartClient components, whilst allowing client-side views of your enterprise data to \n            be trimmed declaratively.\n            "
                            },
                            {
                                icon:"[ISO_DOCS_SKIN]/images/iconexperience/funnel.png",
                            ...
                            },
                            {
                                ...
                                description:"\n            Hibernate's <code>Criteria</code> object can be created from SmartClient's \n            <code>DSRequest</code> in order to fulfill the \"fetch\" operation, with data paging \n            enabled.  Hibernate-managed beans can be populated with inbound, validated data\n            with a single method call.<p>\n            Note that this example shows one approach to integration with Hibernate, specifically \n            in the case where there is pre-existing Spring logic.  For a new application, use the \n            SQLDataSource or HibernateDataSource - these allow for immediate connection to a SQL\n            or Hibernate data store without the need to write any server-side code at all.\n            "
                            },
                            {
                            ...
                            },
                            {
                                ...
                                showSkinSwitcher:false,
                                showSource:true,
                                title:"Automatic Transaction Management (Hibernate)",
                            ...
                            },
                            {
                                ...
                                tabs:[
                                    ...
                                    },
                                    {
                                        canEdit:"false",
                                        doEval:"false",
                                        title:"SupplyItemORM.java",
                                        url:"serverExamples/other/reusableORMDataSource/SupplyItemORM.java"
                                    },
                                    {
                                        canEdit:"false",
                                        doEval:"false",
                                        title:"SupplyItemORM.hbm.xml",
                                        url:"serverExamples/other/reusableORMDataSource/SupplyItemORM.hbm.xml"
                                    },
                                    {
                                        canEdit:"false",
                                        doEval:"false",

 ...
 isc.RestDataSource.create({
	    ...
	    fields:
	        [
	            ...
	            {hidden:"true",name:"id",primaryKey:"true",type:"integer"},
	            {name:"RadioSchoolName",type:"string",title:"نام "},
	            {name:"RadioTitle",type:"string",title:"عنوان"},
	            {name:"RadioDescription",type:"string",title:"توضیحات"},
...
{name:"AbstractFile",click:function(a,b){
 ...
 {/literal}
	  ...
	  */
	  ...
	  var detailDs1Name='RadioSchool_Publisher';
	  isc.RestDataSource.create({
	  	 {/literal}
	  	 {$this->GetDataSource('detailDs1Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/Publishers/')}
	  	 {literal}
	    fields:
	 ...
	 */
	 ...
	 var detailDs2Name='RadioSchool_Writer';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs2Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/Writers/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 */
	 ...
	 var detailDs3Name='RadioSchool_TechnicalExpert';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs3Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/TechnicalExperts/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 */
	 ...
	 var detailDs4Name='RadioSchool_TechnicalSupervisor';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs4Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/TechnicalSupervisors/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 /***********************************************************************************************
	 Detail Section - RadioPrints
	 */
	  var detailGrid5Name = 'Detail_RadioPrint_Grid';
	  var detailForm5Name = 'Detail_RadioPrint_Form';
	  var detailDs5Name='RadioSchool_RadioPrint';
	  isc.RestDataSource.create({
	  	 {/literal}
	  	 {$this->GetDataSource('detailDs5Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/RadioPrints/')}
	  	 {literal}
	    fields:
	  	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 */
	 ...
	 var detailDs6Name='RadioSchool_TypeSetter';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs6Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/TypeSetters/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 */
	 ...
	 var detailDs7Name='RadioSchool_Editor';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs7Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/Editors/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 */
	 ...
	 var detailDs8Name='RadioSchool_PageStylist';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs8Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/PageStylists/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 */
	 ...
	 var detailDs9Name='RadioSchool_Graphist';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs9Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/Graphists/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 */
	 ...
	 var detailDs10Name='RadioSchool_Preparator';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs10Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/Preparators/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
	 ...
	 */
	 ...
	 var detailDs11Name='RadioSchool_LitoGraphist';
	 isc.RestDataSource.create({
	 	 {/literal}
	 	 {$this->GetDataSource('detailDs11Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/LitoGraphists/')}
	 	 {literal}
	   fields:
	 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
 ...
 */
 ...
 var detailDs12Name='RadioSchool_BookBinder';
 isc.RestDataSource.create({
 	 {/literal}
 	 {$this->GetDataSource('detailDs12Name','/jahad/Human/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/BookBinders/')}
 	 {literal}
   fields:
 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
 ...
 */
 ...
 var detailDs13Name='RadioSchool_Audience';
 isc.RestDataSource.create({
 	 {/literal}
 	 {$this->GetDataSource('detailDs13Name','/jahad/Auidunce/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/Audiences/')}
 	 {literal}
   fields:
 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
 ...
 */
 ...
 var detailDs14Name='RadioSchool_EducationalGoal';
 isc.RestDataSource.create({
 	 {/literal}
 	 {$this->GetDataSource('detailDs14Name','/jahad/FilmEducationalGoal/jdsenum/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/EducationalGoals/')}
 	 {literal}
   fields:
 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
 ...
 */
 var detailGrid15Name = 'Detail_RadioContentList_Grid';
 var detailForm15Name = 'Detail_RadioContentList_Form';
 var detailDs15Name='RadioSchool_RadioContentList';
 isc.RestDataSource.create({
 	 {/literal}
 	 {$this->GetDataSource('detailDs15Name','/jahad/RadioContentList/jds/_5cIRERP_5cmodules_5cjahad_5cmodels_5cRadioSchool/ContentList/')}
 	 {literal}
   fields:
 	        [ {hidden:"true",name:"HelpField",primaryKey:"true",type:"integer"},
 	                {hidden:"true",name:"id",primaryKey:"true",type:"integer"},
 ...
 {$this->GetSectionStack("مدرسه رادیویی",
		 					"جزییات مدرسه رادیویی")}
 {literal}
